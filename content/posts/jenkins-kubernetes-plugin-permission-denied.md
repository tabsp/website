...
description: "在使用 Jenkins 的 kubernetes-plugin 插件时发现使用 Gradle 镜像 构建项目时出现 Permission denied 错误，具体错误如下："
date: 2018-08-20
tags: [Jenkins, Java, Kubernetes, DevOps]
draft: false
slug: "jenkins-kubernetes-plugin-permission-denied"
---
