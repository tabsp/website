...
description: "在这个部分，将需要产生多个元件的 Certificates，这包含 Etcd、Kubernetes 元件等，并且每个集群都会有一个根数位凭证认证机构 (Root Certificate Authority) 被用在认证 API Server 与 Kubelet 端的凭证。"
date: 2018-05-30
tags: [Jenkins, Java, Kubernetes]
draft: false
slug: "install-k8s-1-10-3-02"
---
