...
description: "上一篇文章介绍了手动安装并配置 Xray 的 REALITY 协议，但是支持 REALITY 协议的 iOS 的客户端太少，所以打算同时安装一个 Hysteria 2 作为补充。目前来看 Xray core 短期内不会支持 Hysteria 2，故考虑使用 nginx 同时反代 Xray 和 Hysteria 2。"
date: 2024-12-17
tags: [xray, reality, hysteria2, nginx]
draft: false
slug: "nginx-sni-vless-reality-vision-xhttp-hysteria2-web"
---
